...
当前源码版本为 `v2.1.0`。仓库同时通过 Git 标签完整保留 `v1.0.0` 与 `v2.0.0` 的已发布状态。
...
详细内容见 [v1.0.0 版本说明](docs/VERSION-1.0.0.md)、[v2.0.0 版本说明](docs/VERSION-2.0.0.md)、[v2.1.0 版本说明](docs/VERSION-2.1.0.md)和[完整评估报告](docs/EVALUATION-2026-08-06.md)。原始匿名候选、评分规程和盲评结果保存在 [`tests/2026-08-06/`](tests/2026-08-06/)，本次结晶化定向回归保存在 [`tests/2026-08-10/`](tests/2026-08-10/)。
